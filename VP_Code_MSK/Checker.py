...
try:
    os.remove('MSK_checker.session-journal')
except Exception:
    pass

api_id = 38450983
api_hash = 'ae38cd298bfe81d26249057e3545b77c'
session_name = 'MSK_checker'
client = TelegramClient(session_name, api_id, api_hash)

MY_CHANNEL = 2873921635  # username или id канала, а не ссылка
MY_CHANNEL_LINK = 'https://t.me/+EMotuavIgaliMWFi'
